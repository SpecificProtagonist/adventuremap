...
data merge entity @e[tag=boss2_main,limit=1] {Attributes:[{Name:"generic.movementSpeed",Base:.16},{Name:generic.attackDamage,Base:5}],Health:25,ArmorItems:[{},{},{id:"leather_chestplate",Count:1,tag:{display:{color:3934730}}},{id:"leather_helmet",Count:1,tag:{display:{color:3934730}}}],ArmorDropChances:[0f,0f,0f,0f]}
...
execute if entity @e[tag=boss2,scores={boss_health=1}] at @e[tag=boss2_main] run summon zombie ~ ~ ~ {IsBaby:true,ActiveEffects:[{Id:12,Duration:10000,ShowParticles:false},{Id:14,Duration:10000,ShowParticles:false}],Fire:10000,Tags:[boss2_miniminion,mob],Attributes:[{Name:"generic.movementSpeed",Base:.2},{Name:generic.attackDamage,Base:3}],Health:2,Silent:1}
