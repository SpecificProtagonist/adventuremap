...
execute if entity @s[tag=agro2] at @s as @e[tag=mob,distance=..2.5] run data merge entity @s {NoAI:false}
execute if entity @s[tag=agro5] at @s as @e[tag=mob,distance=..5.5] run data merge entity @s {NoAI:false}
execute if entity @s[tag=agro9] at @s as @e[tag=mob,distance=..9.5] run data merge entity @s {NoAI:false}
