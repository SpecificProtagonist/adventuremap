...
execute at @e[tag=boss1_center] positioned ~1.6 ~ ~1 run summon area_effect_cloud ~ ~ ~ {Color:16777215,Radius:.1,Duration:9999999,RadiusOnUse:0,RadiusPerTick:0,Tags:["ItemCloud"],Passengers:[{id:hopper_minecart,Tags:["Item"],Enabled:0,CustomName:'{"text":"Item"}',CustomDisplayTile:true,DisplayOffset:-10,DisplayState:{Name:sea_lantern},Invulnerable:1,Items:[{Slot:2b,id:carrot_on_a_stick,Count:1,tag:{Damage:2,spell:"small_fireball",Unbreakable:1,HideFlags:63,display:{Lore:['{"text":"1 Mana"}','{"text":"Throw a small fireball"}'],Name:'{"text":"Fireball Staff"}'}}}]}]}
