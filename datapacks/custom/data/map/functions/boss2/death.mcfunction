...
execute at @e[tag=boss2] run summon area_effect_cloud ~ ~ ~ {Color:16777215,Radius:.1,Duration:9999999,RadiusOnUse:0,RadiusPerTick:0,Tags:["ItemCloud"],Passengers:[{id:hopper_minecart,Tags:["Item"],Enabled:0,CustomName:'{"text":"Item"}',CustomDisplayTile:true,DisplayOffset:-10,DisplayState:{Name:sea_lantern},Invulnerable:1,Items:[{Slot:2b,id:carrot_on_a_stick,Count:1,tag:{Damage:5,spell:"fireball",Unbreakable:1,HideFlags:63,display:{Lore:['{"text":"3 Mana"}','{"text":"Throw a exploding fireball."}','{"text":"The flame is a hungry dog"}','{"text":"on the pyromancers leash,"}','{"text":"be careful it doesn\'t bite you"}'],Name:'{"text":"Greater Fireball Staff"}'}}}]}]}
