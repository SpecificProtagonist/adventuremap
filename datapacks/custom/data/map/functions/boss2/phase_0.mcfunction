...
execute if entity @p[scores={eventTimer=295}] run summon wither 1004 83 970 {Tags:[mob,boss2],Attributes:[{Name:"generic.max_health",Base:800}],Silent:true,Health:800,CustomName:"§rFire Demon"}

execute if entity @p[scores={eventTimer=300}] run summon zombie 1004 93 970 {ActiveEffects:[{Id:12,Duration:10000,ShowParticles:false},{Id:14,Duration:10000,ShowParticles:false}],Fire:10000,Tags:[boss2_minion,mob],Attributes:[{Name:"generic.movement_speed",Base:.22},{Name:generic.attack_damage,Base:3}],Health:20,Silent:1}
execute if entity @p[scores={eventTimer=300}] run summon zombie 1004 93 970 {ActiveEffects:[{Id:12,Duration:10000,ShowParticles:false},{Id:14,Duration:10000,ShowParticles:false}],Fire:10000,Tags:[boss2_minion,mob],Attributes:[{Name:"generic.movement_speed",Base:.22},{Name:generic.attack_damage,Base:3}],Health:20,Silent:1}
execute if entity @p[scores={eventTimer=300}] run summon zombie 1004 93 970 {ActiveEffects:[{Id:12,Duration:10000,ShowParticles:false},{Id:14,Duration:10000,ShowParticles:false}],Fire:10000,Tags:[boss2_minion,mob],Attributes:[{Name:"generic.movement_speed",Base:.22},{Name:generic.attack_damage,Base:3}],Health:20,Silent:1}
execute if entity @p[scores={eventTimer=300}] run summon zombie 1004 93 970 {ActiveEffects:[{Id:12,Duration:10000,ShowParticles:false},{Id:14,Duration:10000,ShowParticles:false}],Fire:10000,Tags:[boss2_minion,mob],Attributes:[{Name:"generic.movement_speed",Base:.22},{Name:generic.attack_damage,Base:3}],Health:20,Silent:1}

execute if entity @p[scores={eventTimer=300}] run playsound minecraft:entity.tnt.primed master @p 1008 96 974 2 1 1
execute if entity @p[scores={eventTimer=300}] run summon zombie 1004 93 970 {ActiveEffects:[{Id:12,Duration:10000,ShowParticles:0},{Id:14,Duration:10000,ShowParticles:0}],Fire:10000,Tags:[boss2_main,mob],Attributes:[{Name:"generic.movement_speed",Base:.18},{Name:generic.attack_damage,Base:5}],Health:25,ArmorItems:[{},{},{id:"leather_chestplate",Count:1,tag:{display:{color:3934730}}},{id:"leather_helmet",Count:1,tag:{display:{color:3934730}}}]}
