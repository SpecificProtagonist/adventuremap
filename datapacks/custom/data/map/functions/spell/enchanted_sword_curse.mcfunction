...
give @s golden_sword{Damage:15,Unbreakable:1,HideFlags:63,display:{Lore:["10 Magic Damage, Medium","The word 'Curse' is engraved","at the base of the blade."],Name:"§rCurse Sword"},AttributeModifiers:[{UUIDLeast:1,UUIDMost:6,Name:"a",Slot:mainhand,Operation:0,AttributeName:"generic.attack_damage",Amount:9f},{UUIDLeast:2,UUIDMost:6,Name:"a",Slot:mainhand,Operation:1,AttributeName:"generic.attackSpeed",Amount:-.8f}],weaponType:3,dualWield:0,ench:[{id:19,lvl:2}]}
