...
tp @p ~-1489 ~-12 ~-533
setblock 1004 97 1000 lever facing=up_z,powered=false
playsound minecraft:block.piston.contract master @p -485 86 473 2 .6
setblock -485 85 467 lever facing=up_z,powered=true
...
setblock -485 85 476 lever facing=up_z,powered=false
