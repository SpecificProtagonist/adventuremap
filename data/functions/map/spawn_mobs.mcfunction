...
execute @e[tag=mobPosZombieFast] ~ ~ ~ summon Zombie ~ ~ ~ {PersistenceRequired:true,Attributes:[{Name:"generic.movementSpeed",Base:.3}],Health:20,Tags:[mob,zombieFast],DeathLootTable:"mob:zombieFast"}

execute @e[tag=mobPosZombie] ~ ~ ~ summon zombie_villager ~ ~ ~ {PersistenceRequired:true,Tags:[mob,zombie],DeathLootTable:"mob:zombie"}

execute @e[tag=mobPosZombieFeeble] ~ ~ ~ summon zombie_villager ~ ~ ~ {PersistenceRequired:true,Attributes:[{Name:"generic.maxHealth",Base:5},{Name:"generic.movementSpeed",Base:.04}],Tags:[mob,zombie],DeathLootTable:"mob:zombie"}
