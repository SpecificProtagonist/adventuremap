...
scoreboard players tag @p add cast_regen {SelectedItem:{tag:{display:{Name:"§rTalisman of Regeneration"}}}}
scoreboard players tag @p add cast_tentacle_beast {SelectedItem:{tag:{display:{Name:"§rBlack Tentacle"}}}}
scoreboard players tag @p add cast_small_fireball {SelectedItem:{tag:{display:{Name:"§rFireball Staff"}}}}
scoreboard players tag @p add cast_fireball {SelectedItem:{tag:{display:{Name:"§rGreater Fireball Staff"}}}}
scoreboard players tag @p add cast_cursed_fireball {SelectedItem:{tag:{display:{Name:"§rStaff of Cursed Flames"}}}}
scoreboard players tag @p add cast_enchanted_sword_fire {SelectedItem:{tag:{display:{Name:"§rFire Sword"}}}}
scoreboard players tag @p add cast_enchanted_sword_curse {SelectedItem:{tag:{display:{Name:"§rCurse Sword"}}}}
scoreboard players tag @p add cast_athame {SelectedItem:{tag:{display:{Name:"§rAthame"}}}}

scoreboard players tag @p add cast_regen {Inventory:[{Slot:-106b,tag:{display:{Name:"§rTalisman of Regeneration"}}}]}
scoreboard players tag @p add cast_tentacle_beast {Inventory:[{Slot:-106b,tag:{display:{Name:"§rBlack Tentacle"}}}]}
scoreboard players tag @p add cast_small_fireball {Inventory:[{Slot:-106b,tag:{display:{Name:"§rFireball Staff"}}}]}
scoreboard players tag @p add cast_fireball {Inventory:[{Slot:-106b,tag:{display:{Name:"§rGreater Fireball Staff"}}}]}
scoreboard players tag @p add cast_cursed_fireball {Inventory:[{Slot:-106b,tag:{display:{Name:"§rStaff of Cursed Flames"}}}]}
scoreboard players tag @p add cast_athame {Inventory:[{Slot:-106b,tag:{display:{Name:"§rAthame"}}}]}
